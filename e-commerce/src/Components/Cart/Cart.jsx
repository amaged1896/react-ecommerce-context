...
export default function Cart() {
    ...
    async function getCartDetails() {
        ...
        setCartEmpty(response.data.numOfCartItems);
    ...
    return (
        <>
            ...
            {cartDetails && cartEmpty ? <div className="container py-5 my-5 bg-main-light p-5">
            ...
            </div> : <div className='d-flex justify-content-center align-items-center my-5'><h1>Cart Is Empty</h1></div>}
        </>
    );
}
